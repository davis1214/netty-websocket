...
public class SpringNettyConfig {
    ...
    @Value("${websocket.server.redis.nodes}")
    private String nodes;

    @Value("${websocket.server.redis.useSingleServer}")
    private boolean useSingleServer;
    ...
    public SocketIOServer server(Config config) {
        ...
        configuration.setContext(WebSocketConstant.Context);
