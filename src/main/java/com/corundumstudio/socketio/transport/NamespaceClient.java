...
public class NamespaceClient implements SocketIOClient {
    ...
    private static final Logger log = LoggerFactory.getLogger(com.corundumstudio.socketio.transport.NamespaceClient.class);
...
//        onDisconnect();
    ...
    public boolean equals(Object obj) {
        ...
        com.corundumstudio.socketio.transport.NamespaceClient other = (com.corundumstudio.socketio.transport.NamespaceClient) obj;
    ...
    @Override
    public void joinRoom(String room, String userKey) {
        namespace.joinRoom(room, getSessionId(), userKey);
    }
    ...
    @Override
    public void leaveRoom(String room, String userKey) {
        namespace.leaveRoom(room, getSessionId(), userKey);
    }
