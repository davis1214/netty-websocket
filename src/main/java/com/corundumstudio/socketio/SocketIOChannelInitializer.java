...
public class SocketIOChannelInitializer extends ChannelInitializer<Channel> implements DisconnectableHub {
    ...
    private static final Logger log = LoggerFactory.getLogger(com.corundumstudio.socketio.SocketIOChannelInitializer.class);
    ...
    public void start(Configuration configuration, NamespacesHub namespacesHub) {
        ...
        log.info("start to get store factory");
        StoreFactory factory = configuration.getStoreFactory();
        log.info("got store factory");
    ...
    /**
     * Adds the com.corundumstudio.com.corundumstudio.socketio channel handlers
     *
     * @param pipeline - channel pipeline
     */
