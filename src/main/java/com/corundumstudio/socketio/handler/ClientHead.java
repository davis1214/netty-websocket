...
public class ClientHead {
    ...
    private static final Logger log = LoggerFactory.getLogger(com.corundumstudio.socketio.handler.ClientHead.class);

    public static final AttributeKey<com.corundumstudio.socketio.handler.ClientHead> CLIENT = AttributeKey.<com.corundumstudio.socketio.handler.ClientHead>valueOf("client");
