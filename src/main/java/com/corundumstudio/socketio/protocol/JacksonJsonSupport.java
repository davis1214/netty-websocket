...
public class JacksonJsonSupport implements JsonSupport {
    ...
    private class EventDeserializer extends StdDeserializer<com.corundumstudio.socketio.protocol.Event> {
        ...
        protected EventDeserializer() {
            super(com.corundumstudio.socketio.protocol.Event.class);
        }

        @Override
        public com.corundumstudio.socketio.protocol.Event deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException,
                JsonProcessingException {
            ObjectMapper mapper = (ObjectMapper) jp.getCodec();
            ...
            if (!eventMapping.containsKey(ek)) {
                ...
                if (!eventMapping.containsKey(ek)) {
                    return new com.corundumstudio.socketio.protocol.Event(eventName, Collections.emptyList());
                }
            }

            List<Object> eventArgs = new ArrayList<Object>();
            com.corundumstudio.socketio.protocol.Event event = new com.corundumstudio.socketio.protocol.Event(eventName, eventArgs);
    ...
    protected static final Logger log = LoggerFactory.getLogger(com.corundumstudio.socketio.protocol.JacksonJsonSupport.class);
    ...
    protected void init(ObjectMapper objectMapper) {
        ...
        module.addDeserializer(com.corundumstudio.socketio.protocol.Event.class, eventDeserializer);
