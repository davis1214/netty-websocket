...
public enum Transport {
    ...
    public static com.corundumstudio.socketio.Transport byName(String value) {
        for (com.corundumstudio.socketio.Transport t : com.corundumstudio.socketio.Transport.values()) {
